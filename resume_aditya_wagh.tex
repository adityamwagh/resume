...
% sections formatting
\titleformat{\section}
{\vspace{-4pt} \color{LightGray}\hrule height 0.7pt width \pdfpagewidth \vspace{3pt} \bfseries \large}
{}{0em}{\centering \color{Black}\MakeUppercase}[ \hrule height 0.7pt \vspace{-4pt}]
