...
\ItemListStart{}
\ItemDesc{Developing Transformer and Graph NN based semi-supervised and unsupervised models to improve \textbf{pair-wise registration of LiDAR point cloud with a low overlap ratio}}
\ItemDesc{Experimented with fully-convolutional and attention based \textbf{outlier rejection} techniques to find the overlapping region between two point clouds}
\ItemListEnd{}
